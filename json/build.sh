...
#std_data_json
dmd -ofjson_d_new -O -release -inline -w -Istd_data_json/source/ std_data_json/source/stdx/data/json/*.d test_new.d
gdc -o json_d_new_gdc -frelease -finline-functions -O3 -Werror -Wall -Istd_data_json/source/ std_data_json/source/stdx/data/json/*.d test_new.d
ldc2 -ofjson_d_new_ldc -O5 -release -enable-inlining -w -oq -Istd_data_json/source/ std_data_json/source/stdx/data/json/*.d test_new.d

#std_data_json streamed
dmd -ofjson_d_new_lazy -O -release -inline -w -Istd_data_json/source/ std_data_json/source/stdx/data/json/*.d test_new_lazy.d
gdc -o json_d_new_lazy_gdc -frelease -finline-functions -O3 -Werror -Wall -Istd_data_json/source/ std_data_json/source/stdx/data/json/*.d test_new_lazy.d
